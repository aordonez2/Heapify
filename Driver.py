...
def main():
    """ Mian function initializes fucntions to get user input 
    to build our un-heapify tree and to the heapipy function.
    along with displaying thr data fro the heapify verion 
    """    """"""
    myHeap = Heap.Heap()
    myHeap.read_paths()
